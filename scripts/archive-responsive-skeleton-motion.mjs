...
export const MATERIAL = 'responsive-cell-skeleton-v6'
export const REPORT = 'docs/responsive-skeleton-motion-validation-2026-09-12.json'
export const ARCHIVE = 'data/experiments/responsive-skeleton-motion-2026-09-12'
export const ARTIFACTS = 'output/playwright/responsive-skeleton-motion-2026-09-12'
...
const FILES = [
  ...
  'components/settle/use-replay.ts', 'components/settle/settle-stage.tsx', 'lib/settle/ambient-geometry.ts', 'lib/settle/answer-envelope.ts',
  ...
  'scripts/measure-responsive-skeleton-motion.mjs', 'scripts/archive-responsive-skeleton-motion.mjs', 'scripts/measure-anchored-skeleton-motion.mjs',
]
...
export async function archiveResponsive(report, root) {
  if (report.material !== MATERIAL || report.schemaVersion !== 1 || report.results.length !== 8) throw Error('Expected eight v6 observations')
