...
const ACCENTS = [
  'oklch(0.49 0.19 252)', // blue
  'oklch(0.52 0.21 300)', // violet
  'oklch(0.52 0.22 352)', // magenta
  'oklch(0.52 0.20 27)', // red
  'oklch(0.47 0.12 196)', // teal
  'oklch(0.47 0.14 158)', // deep green
...
export const RAINBOW_ACCENT =
  'linear-gradient(90deg, oklch(0.5 0.2 25) 0 14.286%, oklch(0.5 0.16 65) 14.286% 28.571%, oklch(0.47 0.13 160) 28.571% 42.857%, oklch(0.47 0.12 198) 42.857% 57.143%, oklch(0.49 0.19 255) 57.143% 71.429%, oklch(0.52 0.21 300) 71.429% 85.714%, oklch(0.52 0.22 352) 85.714% 100%)'
