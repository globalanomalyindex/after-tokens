...
//
// Pointer-fine devices only, and respects reduced-motion via the shared
// reactive hook, so toggling the OS setting mid-session tears the loop down
// without needing a reload (it simply doesn't mount, leaving the native
// cursor and the chips' static dotted borders).
