...
const REGISTERS: { label: string; body: string; sample: React.ReactNode }[] = [
  ...
  { label: 'spin', body: 'the reel below the floor: the model\u2019s guess for an open position at any probability, drawn as a smear of the secondary ink, blurred past reading and weighted by that probability. every change of guess is a turn of the reel, so wherever the model is guessing the reel visibly turns, and nothing below the floor is drawn as legible text', sample: <span className="settle-zone settle-legend"><span className="settle-cz" data-state="spin" style={{ ['--p' as string]: 0.3 } as CSSProperties}>the</span> <span className="settle-cz" data-state="spin" style={{ ['--p' as string]: 0.8 } as CSSProperties}>light</span></span> },
  ...
  return (
    <Section id="field" title="What settles first">
      ...
      <p className="standfirst max-w-3xl">
        ...
        blurred past reading, weighted by its probability, so wherever the model is guessing the reel visibly turns; a guess
