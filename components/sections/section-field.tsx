  ...
  return (
    <Section id="field" title="What settles first">
      ...
      <p className="standfirst max-w-3xl">
        ...
        visibly turns, while a guess it makes at four or more positions at once is its prior and is drawn as blank; a guess
