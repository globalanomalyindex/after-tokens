  ...
  return (
    <Section id="playground" title="Try it">
      ...
      <p className="standfirst max-w-3xl">
        every recording the hand audit kept, under any sampler, policy, voice and clock, with the raw prefix beside
        it if you want it. the readout is the chosen policy&rsquo;s cost over the whole corpus; the stage is one run.
      </p>
        ...
        <SettleStage
          ...
          readout={({ policy, preview }) => {
            ...
            const rows: [string, string][] = [
              ...
              ['forming in view', preview ? `${Math.round((u.medianFormingShare ?? 0) * 100)}% of the run` : 'held, as margin did'],
