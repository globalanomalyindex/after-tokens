...
const LEDGER: Row[] = [
  ...
  { mechanism: 'motion in the periphery', source: 'Bartram, Ware and Calvert, 2003', says: 'motion beside a primary task is detected far better than a color change; traveling and zooming icons were rated the most distracting, slow linear motion and slow blink the least.', does: 'concern text, or an object the reader is meant to follow.', design: 'a guardrail. the flock drifts slowly along the open stream and never blinks; a draft changes by a slow fade; a word builds in place; nothing travels across the answer.', verdict: 'guardrail' },
