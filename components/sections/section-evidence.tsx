...
const LEDGER: Row[] = [
  ...
  { mechanism: 'motion in the periphery', source: 'Bartram, Ware and Calvert, 2003', says: 'motion beside a primary task is detected far better than a color change; traveling and zooming icons were rated the most distracting, slow linear motion and slow blink the least.', does: 'concern text, or an object the reader is meant to follow.', design: 'a guardrail. a draft changes by a slow fade and never blinks; the only thing that travels is the one thing the reader is meant to follow.', verdict: 'guardrail' },
  ...
  { mechanism: 'visible process, explained waits', term: 'labor illusion', source: 'Buell and Norton, 2011; Maister, 1985; Zhang and colleagues, 2024', says: 'showing work raises perceived value; unexplained and uncertain waits feel longer; a justified delay reads as more trustworthy.', does: 'show that a field of cells has these effects, or that it does not also raise unwarranted trust.', design: 'the field shows what the sampler has done and why the page waits. it never encodes confidence or correctness.', verdict: 'kept' },
  { mechanism: 'pacing at linguistic boundaries', source: 'Zhu and colleagues, CHI 2026; Tan and Nov, CHI 2026', says: 'streaming paused at clause and sentence boundaries was rated less demanding than constant-rate streaming; an instant answer was rated less thoughtful than one with a short visible delay.', does: 'concern non-sequential sources; both studies stream left to right. recent enough that citation details are moderately, not fully, confirmed.', design: 'the page takes whole sentences; the forming text and field carry the delay.', verdict: 'kept' },
