...
const LEDGER: Row[] = [
  ...
  { mechanism: 'motion in the periphery', source: 'Bartram, Ware and Calvert, 2003', says: 'motion beside a primary task is detected far better than a color change; traveling and zooming icons were rated the most distracting, slow linear motion and slow blink the least.', does: 'concern text, or an object the reader is meant to follow.', design: 'a guardrail. a change of guess is a short roll in place; a word builds in place and stops with one bounce; the set is one movement, over within itself; nothing loops, nothing blinks, and nothing travels across the answer.', verdict: 'guardrail' },
