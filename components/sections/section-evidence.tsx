...
const LEDGER: Row[] = [
  { mechanism: 'stability of text under the eye', term: 'change blindness', source: 'Liu and colleagues, CHI 2023; Slattery, Angele and Rayner, 2011', says: 'in live captions, revising text already on screen correlates with distraction, fatigue and harder reading; a change under a fixation is detected unless timed to a saccade.', does: 'test a diffusion surface, or say how much stillness is enough.', design: 'the page never changes, moves, blurs or reweights.', verdict: 'kept' },
