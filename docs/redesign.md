...
The motes were the first thing to go: a body shooting smaller bodies at the words was the wrong picture, and a body nodding at them was still a character standing between the reader and the text. What the user asked for instead was the thing itself: text visibly constructed, iteratively and out of order, at several places at once, smoothly, with the size and the formatting of the message settled first, and the undecided part of the answer carrying something alive while it is being figured out. So the companion is gone, and the reserved space does the work.
