...
describe('the authored ambient composition', () => {
  it('preserves animated nodes through pauses and compact tail exposure', () => {
    ...
    rerender(<AmbientComposition active motion complete={false} runId="run" rowCount={2} lineHeightPx={26} barHeightPx={14.4} />)
