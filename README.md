...
| **built** | a responsive case-study website, an authored cinematic opening, an upfront live comparison, interactive skeleton comparisons, brand controls, real source replays, an authored snapshot exercise, a Google reference inspector, secondary application sketches, source audits and a presentation-cost instrument |
...
designed and built by Christopher Robin Fiore, `globalanomalyindex` on GitHub. my design record follows the causal audit and first reading contract of 7 september 2026 under the name margin, then the motion revisions, source experiments and evidence refresh of 9 september. recorded trajectories and text are cc by 4.0; code is mit.
